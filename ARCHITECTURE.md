...
The clean default startup set is only `AGENTS.md` plus generated `Memory/Agent Memory/start.md` (1,796 bytes / 227 `wc` words). Editable sources and cold history are behind explicit routes.
